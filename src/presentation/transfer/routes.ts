...
import { HotelBedsTrasnferDatasource, TransferRepositoryIml } from "../../infraestructure";
...
export class TransferRoutes {
  static get routes() {
    ...
    const transferRepository = new TransferRepositoryIml(hotelBedsTransferDatasource);
